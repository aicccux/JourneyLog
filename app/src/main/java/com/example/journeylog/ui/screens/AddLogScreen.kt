...
fun AddLogScreen(
    ...
    Scaffold(snackbarHost = { SnackbarHost(snackBarHostState) }, topBar = {
        ...
        Column(
            ...
            // region Date
            ListItem(headlineContent = { Text("Date") }, trailingContent = {
                DatePickerCompose(
                    state.date, onChange = viewModel::onDateChange
                )
            })
            HorizontalDivider()
            // endregion
            ...
            // region Location
            ListItem(headlineContent = { Text("Location") }, trailingContent = {
            ...
            // region Photos
            ListItem(headlineContent = { Text("Photos") }, trailingContent = {
                Row {
                    // region Photo Picker
                    TextButton(onClick = {
                        canAddPhoto {
            ...
            PhotoGrid(modifier = Modifier.padding(16.dp),
